...
% smith2006homogenization: "Homogenization theories are typically valid when the unit-cell size is in-
%significant with respect to the wavelength (the zero-
%frequency limit) and thus might be expected to result in a
%poor description of metamaterials."

%%% /home/filip/PhD/Sources\_MM\_theory/120626\_Homogenisation\_approaches

% --------------------------------

\cite{simovski2007bloch, simovski2009material, simovski2011electromagnetic} 
...
% An important question arises as to what extent each homogenization procedure is applicable, and when its theory can fail.
