...
% TODO add supershort examples from the History section here
% Note that not all related research was focused on electromagnetism -- for example, the Bloch theorem, discussed later in this thesis, was originally developed for the electron waves in solids (F. Bloch, \todo{19xx}).
...
Out of all structures studied in photonics, particularly strong theoretical attention was attracted to structures that are periodic. %% TODO this needs stylistic fixes
...
Interestingly, different paradigms emerged, and only later they joined, as is discussed in more details in the further text.
One paradigm of \textit{photonic crystals} was inspired by the electron waves in crystals; slightly later the paradigm of \textit{metamaterials} was inspired by the electromagnetic waves in homogeneous materials. 
...
% 0  present an accessible introduction to the topic
...
% 5  stress that the metamaterial and photonic crystal fields should be unified in terminology and approaches
...
The Bloch theorem follows, along with its mathematical proof, which enables to recognize the traits of the continuum electrodynamics also in waves propagating in periodic structures. The impact on the shape of dispersion curves and on the ambiguity of the wave vector is discussed.
