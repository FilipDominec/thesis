...
The local electrodynamics serves as a basis for transforming into the so-called Landau-Lifshitz (or, $EDB$) formulation of electrodynamics for spatially-dispersive media, which is elaborated more in detail. In the author's opinion, this topic does not receive due attention in most of the literature.
