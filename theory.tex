...
An important note shall be made on the sign convention for the complex wave. We use the `engineering' convention of time dependence: $e^{\ii \omega t}$, but this is only due to the author's feeling that it is more natural when the wave phase grows in time. It is used roughly in half of the literature 
...
\paragraph{Electromagnetic waves in periodic structures}
\add{
