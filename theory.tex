...
With this in mind, the author believes that there is no need for a strict rule for classification. Some structures are then more useful to be subject to homogenization, and with some other it is more interesting to focus on their band and band-gap structure. 
