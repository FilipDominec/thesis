...
A different class of band-gaps, denoted also as \textit{photonic band-gaps}, or PBG, is formed exclusively in periodic structures, whenever there are two different solutions at the same wavevector. % They are typical by 
...
The scenario of a wave being reflected from a structure having a photonic band-gap can be intuitively explained as the partial waves reflected from the elements being all nearly in phase, thus amplifying the reflected wave.
%% TODO put this into the Result section?

In contrast with the individual resonance, the behaviour of the structure does not fundamentally change between the lower and upper band-gap edge. The difference can however be always found in the location of the \textit{nodal planes}. 
