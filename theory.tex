...
X-ray scattering on atomic lattices observed by Max von Laue (details?)
explained by WH+WL Bragg (NP 1915) as narrow band-gap

TODO add the blue-green boxes from printed
independently of periodic structures Veselago in 1968 discusses a *homogeneous* medium with negative index of refraction
