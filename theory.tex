...
where we defined the \textit{speed of light} $c := \frac{1}{\sqrt{\mu_0 \varepsilon_0}}$.
 ...
 \end{enumerate}
%% TODO add figure: dispersion relation in vacuum
%}}}
...
The wave equation then changes to
$$\quad\quad\quad\quad\quad - \kk (\kk \cdot \E) + k^2 \E = \varepsilon_0 \epsrl(\omega) \mu_0 \murl(\omega) \omega^{2} \E,
\quad\quad\quad\quad\quad\text{(\ref{eq_wavek} again)}$$
which results in the dispersion curve for the transverse electromagnetic wave 
...
Noticing that the leftmost term in 
$$ \quad\quad\quad\quad\quad$$
is also a linear transformation of the vector $\E$, expressed by the tensor
$$ - \kk (\kk \cdot \E) \equiv 
...
%	\left(\begin{array}{c} E_x \\ E_y \\ E_z \end{array} \right),
%	$$
the dispersion relation can be reformulated \cite[pp. 667]{born1999book} as a requirement for the following determinant to be zero:
\begin{equation} 
	\left|\begin{array}{ccc} 
