...
The result is also the index of refraction being close to zero, $N\sim 0$. 
The scientific interest to this class started with the paper of  %% TODO
...
Typical for this class is a very low wavevector, which can be approximated to the case of the whole $N\sim 0$ region oscillating in-phase. Wave impinging from air to such a medium refracts from the normal; for angles higher than the usually small critical angle the wave undergoes the \textit{total external reflection}. 
