...
Although e.g. the physics of the ionosphere involves regions where the permittivity transits from negative to positive values, the scientific interest in designing such media 
significantly grew
% with the paper of ...todo.... published  in ...
after the merging of the paradigm with metamaterials, and therefore such media are often denoted syncretically as \textit{zero-index metamaterials}. This is a somewhat confusing term, as the papers focused on their peculiar macroscopic properties \cite{basharin2013} 
% todo basharin 2013 e n z based phenomena in metamaterials
usually do not discuss any structuration and are thus also applicable to fully homogeneous media of such properties.

Typical of this class of media is a very small wavevector, which can be approximated to the extreme case of the whole $N\sim 0$ region oscillating in-phase. The wave entering a $N\sim 0$ medium at near-normal incidence refracts rapidly from the normal; for angles higher than the very small critical angle the wave undergoes the \textit{total external reflection}. 
...
The concept of cloaking was realized \cite{schurig2006} in 2006 using a microwave metamaterial, and many other followed.
%todo add Schurig: metamaterial electromagnetic cloak at microwave frequencies
...
A simplified task is to construct the \textit{carpet cloak} which conceals the obstacle near a surface \cite{valentine2009}.
%valentine2009 an optical cloak made of dielectrics
...
% TODO The apparent unification of \textit{metamaterials} with \textit{negative index of refraction} should not be perceived as their sole use -- in fact, a notable part of contemporary metamaterial research is based on purely positive index of refraction.
