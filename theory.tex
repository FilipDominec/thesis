%% TODO fix that f is used as frequency (replace with omega) and also as arbitrary function f(t) 
%% TODO get rid of the term "response function" for susceptibility
%% TODO ensure more consistent usage of "dispersion curve", "dispersion relation" and "solution of Maxwell equations"
