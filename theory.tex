...
Subwavelength wire arrays have been used at least since 1898 as microwave polarisers. From the same time, also the concept of assembling a microwave polarisation rotator from organic or metallic helices is known \cite{bose1898rotation, emerson1997work}.
...
%}}}
\paragraph{Unification of structures with uncommon parameters with band-gaps and spatial dispersion}			%% TODO%{{{
