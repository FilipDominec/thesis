...
Here, we will show that the magnetic response can be fully expressed by a certain form of $\epsrn(\omega, \kk)$ dependence on $\kk$. The spatial-dispersive function $\epsrn(\omega, \kk)$ will then consist of
\begin{enumerate}
...
\end{enumerate}
The magnetic permeability becomes a mere constant of the magnetic response of vacuum $\muLL(\omega, \kk) := 1$, thus reducing the complexness of the computation. %% [as in Eq. (\ref{eq_ce})]
