...
with the relative permittivity $\varepsilon_r(\omega)$ and permeability $\mu_r(\omega)$ being two dimensionless functions of frequency, defined in Eq. (\ref{eq_lorentz_eps}, \ref{eq_lorentz_mu}). This results in the dispersion curve for the transverse electromagnetic wave 
...
deviating from the original light line in Fig. \ref{fg_dispersion_vacuum}. 
...
\begin{equation} - \kk (\kk \cdot \E)      +          k^2 \E            = +\varepsilon_0 \mu_0 \varepsilon_r(\omega) \mu_r(\omega)\; \omega^{2} \E, \label{eq_disp_loc}\end{equation}
