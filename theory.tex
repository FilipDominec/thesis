...
In the literature, different terms are used for media  \todo{+}

\textit{Negative-refraction} %% TODO accumulate literature

--- are superset of ---

\textit{negative-index}, \textit{backward-wave} \cite{lindell2001bw}
%% TODO accumulate literature

Media with a negative index of refraction are a subset of negative refraction, for which the notion of index of refraction makes sense, as discussed above.
...
\textit{left-handed} or \textit{doubly-negative}
%% TODO accumulate literature
\todo{add the comments from http://www.wave-scattering.com/negative.html}
}
%}}}
\paragraph{Prediction of focusing by a negative-index slab} %{{{  ================== OK? (readpaper, +img)
