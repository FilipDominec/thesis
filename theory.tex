...
Note that the referred theoretical papers all used the electrodynamics of \textit{homogeneous} media, without assuming microscopic periodicity nor any other technical way how such a medium should be obtained. 
...
\paragraph{Unification of structures with uncommon parameters with band-gaps and spatial dispersion} 
...
% http://anlage.umd.edu/06167594.pdf
