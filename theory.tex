...
Merging of the MM and PhC paradigms brings into the focus % todo
also the structures at the boundary, and it is a pertinent question of whether there are any objective differences between the notions of MMs and PhCs at all. 
...
\end{enumerate}
The difference between electrons in solids and optical photons is in that the wavelength valence-band electrons is similar to the inter-atomic distance ($\approx 10^{-10}$ m), demanding the description through the Bloch theorem, whereas the wavelength of light is at least four order of magnitude larger and does not usually the medium.
