...
The radiation may come from two lasers, mutually detuned by a frequency that is to be generated. %% TODO The lasers may be classical solid state, diodes or e.g. two modes in one infrared QCL. %% TODO cite one classical, and the QCL
...
% TODO  nonlinearity/wakefield?? \cite{tong2012}     [hn15] THz generation in plasma -> 70 THz, detection in ZnTe
 \end{itemize}
