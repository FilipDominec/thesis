...
Pyroelectric detectors convert the heat directly to the electric signal by means of a crystal that changes its polarisation with temperature. In the Golay cells, the incident terahertz pulse heats the air, whose thermal expansion is detected. Such devices usually operate at room temperature.
...
\begin{enumerate}
 ...
 \item{Magnetooptic sampling was also demonstrated,\cite{riordan1997free} based on the Faraday rotation induced by the magnetic component of a transient THz wave.} % TODO CITE
 \end{enumerate}
