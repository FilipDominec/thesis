...
%  * unification of MM and PhC concepts, attempt for clarification of these two terms
%  * explained the typical "antiresonance" in effective parameters, that seems to cause confusion 
...
%      3) the s-parameter method, although widely used, does not always give correct results
%  * illustrated the difference of these results against CDH
%  * stress the importance of taking the spatial dispersion into account
%  * provide the simulation environment which facilitates correct computations, 
%    and solves the phase-ambiguity in the s-parameter method in particular
