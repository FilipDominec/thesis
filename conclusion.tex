...
%		... to account for the material properties depending not only on the frequency, but also on the magnitude of the wave vector.
%  * THEORY historical notes 
...
%    didactic approach that the author felt to be missing in the available literature. This required significantly more involvement
%	 than originally envisaged in the PhD project. 
