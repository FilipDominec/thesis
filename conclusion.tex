...
%  * historical notes proving many concepts are as novel as they may appear 
%  * filled the demand for some starting overview of the common structures
%  * stress the importance of spatial dispersion
%  * unification of MM and PhC concepts
%  * attempt for clarification of these two terms
%  * pointed out the fundamental problems: 
%      1) losses in available materials, 
%      2) excessive spatial dispersion in known structures
%      3) the s-parameter method, although used, does not always give correct results
%  * illustrated the difference of these results against CDH
%  * provide the simulation environment which facilitates correct computations
...
%% * mention tunability?       Where appropriate, we also investigated how this behaviour depends on some external parameter (such as electric field, temperature or illumination) -- in other words, how the \textit{tunability} of the structure can be achieved. ...   Attention  was also paid also to investigate the tunability of their properties depending on external parameters, such as temperature, electric and magnetic fields and illumination. %, i.e. to 



Things that could be pursued further on the basis of the presented work:
observe bianisotropy of the metamaterial particles
