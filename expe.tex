...
%While PWEM method is exclusively used to compute dispersion curves  and 1D TMM, are exclusively used to 
 %mostly specialized for a specific computation, the finite-difference methods 
...
%% \cite{terao2011}
%Different problems of this method are resolved and discussed in the following. 

% employ Fresnel formulas    The actual computation is therefore sometimes denoted also as \textit{Fresnel inversion}.
%}}}
