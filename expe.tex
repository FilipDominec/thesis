...
\begin{figure}
	\centering
	\includegraphics[width=8cm]{Fig6.eps} \caption{\add{\textbf{a,b)}} Real and imaginary parts
	of the arccosine of complex argument. Branch cuts are denoted with thick lines. \textit{}}
	\label{fg_arccos}
\end{figure}
