...
As the source of terahertz pulses, we used an interdigitated emitter from TeraSED, whose principle of operation is described in the previous section.
...
The repetition rate was 70 MHz, giving the pulse energy of roughly 7 nJ, sufficient to induce transient photoconductivity in the interdigitated emitter, 

The voltage between the odd and even wires was 15-20 V, and was modulated in time to increase the noise-resistance of the detection system as described below.
