...
%\cite{yang2015}
Starting with the sparse array with $a=12\rho$, one can clearly identify two individual resonances with familiar impacts on the spectra of $\Neff(f)$. From other parameters, $\eeff(f)$ and $\meff(f)$ 
