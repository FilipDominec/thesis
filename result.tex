...
When aligned parallel to the magnetic field, dielectric cylinders, or, rods, exhibit spectra  similar to the sphere arrays. % TODO ref fig
Unlike sphere arrays, this structure can be characterised by a two-dimensional computation.
