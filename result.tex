...
\add{Anti-resonant response of resonant inclusions \cite{wallen2010}: "antiresonance "may not" come from periodicity, as it is also observed in random structures";
