...
%%% Hole : Results - rearrange, plot, write, finish
%%% TODO TODO TODO TODO TODO TODO 

\paragraph{Antiresonances and problems with local effective parameters}
%% TODO add to the first Mie resonance discussed
\add{Anti-resonant response of resonant inclusions : "antiresonance "may not" come from periodicity, as it is also observed in random structures"; %% \cite{wallen2010}
