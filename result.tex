...
\begin{overpic}[width=0.95\textwidth]{img-meep/Slab_fillfraction015_epsilon_comparison_t.pdf} \put (-1,27) {\textbf{(b)}} \end{overpic}\vspace{-10.5mm}\\
\begin{overpic}[width=0.95\textwidth]{img-meep/Slab_fillfraction015_epsilon_comparison_n.pdf} \put (-1,27) {\textbf{(c)}} \end{overpic}\vspace{-9.5mm}\\
\end{tabular}
\end{figure}
