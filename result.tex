...
In contrast, the transmittance approaches 100 \% farther from the resonance, both towards higher or lower frequencies (see Fig. \ref{fg_CutWires_wireradius1u_cutwidth_comparison}b).

\paragraph{Index of refraction near an individual resonance}
The impact of an individual resonance in a periodic structure to its spectrum of effective index of refraction is characteristic similar among other resonant structures, too. 


\paragraph{Effects of cut distance $d_c$ and wire radius $\rho_w$}
...
Single resonance manipulates the phase by not more than $\pi$. Thus the resonance curve always has its "ceiling" and "floor" in the closest two Brillouin zone boundaries.
