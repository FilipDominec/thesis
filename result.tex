...
\begin{minipage}[c]{0.51\textwidth}
	\hspace{-2mm}\begin{overpic}[width=.99\textwidth]{img-meep/erods_fxplot_cs120e-6.pdf} 
		\put(110,0){\includegraphics[width=.6\textwidth]{img/ERods_sketch_recordedline.pdf}}
		\put(0,90) {\textbf{(a)}} 
	\end{overpic}\\
\end{minipage}
...
\begin{figure}[h!] % fg_fxplot 
\hspace{-2mm}\begin{overpic}[width=.51\textwidth]{img-meep/erods_fxplot_cs95e-6.pdf}  
	\put(0,90) {\textbf{(b)}} 
\end{overpic}
