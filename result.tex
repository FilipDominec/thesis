...
\begin{overpic}[height=0.22\textwidth]{img/drawing_sSRRpad_wire.pdf} \put (1,81) {\textbf{(f)}}\end{overpic}\quad
\end{figure}
...
Metallic \textit{cut-wire pair}, or also \textit{strip pair}, metamaterial was designed for operation in the infrared or optical range. It can be understood as a split-ring resonator elongated in the direction of the electric field. The elongation is chosen so that the electric and magnetic resonances should overlap.	
