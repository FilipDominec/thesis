...
\todo{origin of samples, semi-conductive si substrate, todo compute spectra, plot graphs and compare with experiment}
...
\paragraph{Modifications with higher symmetry}
