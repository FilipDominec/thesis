...
Construction of an optical or near-infrared metamaterial restricts the choice of permittivity of transparent dielectrics to roughly 12, typical for silicon in near-infrared. The particularly simple drawing of the resulting band structure (Fig. \ref{fg_drawn50_12}b) shows that for any unit cell size, the Mie resonance in silicon rod array is always preceded by a Bragg band gap. 

%}}}
\paragraph{Discussion}%{{{
Figs. \ref{fg_drawn100} and \refs{fg_fxplot} shows that dielectric rods do not have to be geometrically touching to start behaving like a 1-D PhC. Strong enough near-field interaction is sufficient, and the exact critical ratio of the radius to the unit cell size $\rho/a > 0.5$ depends on the dielectric permittivity. 


In the array of rods parallel to the electric field, this qualitative change occurs for a particularly low filling fraction.
%% References:
%% Ref. \cite{peng2007} uses $\epsrl=600$ and $a/\rho \sim 3$ (square bars)
%% Ref. \cite{vynck2009all}
%% Ref. \cite{shi2007}
%% 
, similar to 
We conjecture it would be observed in many other kinds of dielectric, or even other, metamaterials, provided their unit cell size would be reduced sufficiently to bring the resonant elements into strong enough interaction with the near field of their neighbours. %% TODO rewrite
