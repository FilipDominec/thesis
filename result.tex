...
\begin{overpic}[width=0.48\textwidth]{img-meep/Slab_fillfraction015_epsilon_scan_ni.pdf}\put (1,95) {\textbf{(b)}}\end{overpic}  % TODO rm voids
%Slab_epsilon4_fillfraction_scan_r.pdf
%Slab_epsilon4_fillfraction_scan_t.pdf
\end{figure}

\begin{figure}[t] \caption{\textbf{(a)} Reflectivity and \textbf{(b)} the imaginary part of the retrieved refractive index for a 1-D PhC, with dielectric permittivity of 4, as a function of frequency and filling fraction} \label{fg_Slab} \centering 
\begin{overpic}[width=0.48\textwidth]{img-meep/Slab_epsilon4_fillfraction_scan_r.pdf}\put (-1,27) {\textbf{(a)}}\end{overpic} % TODO  lower number of contours
%Slab_fillfraction015_epsilon_scan_r.pdf
%Slab_fillfraction015_epsilon_scan_t.pdf
\begin{overpic}[width=0.48\textwidth]{img-meep/Slab_epsilon4_fillfraction_scan_ni.pdf}\put (-1,27) {\textbf{(b)}}\end{overpic} % TODO rm voids
%Slab_epsilon4_fillfraction_scan_r.pdf
%Slab_epsilon4_fillfraction_scan_t.pdf
\end{figure}
