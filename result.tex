...
The transmission is mediated by electromagnetic waves propagating along the metallic surface, i.e., parallel to the $x-$ axis. 
The field distribution is similar to surface plasmons-polaritons (SPP), but particularly in the terahertz range and below it, it is bound to the structure also by means of its corrugation. Such a wave is known as \textit{spoof surface plasmons}.  % todo cite
...
Already in 1950s the perforated sheets were proposed to be periodically arranged to form an artificial dielectric \cite[p. 58]{brown1953artificial} with index of refraction lower than 1, but the field was supposed to propagate parallel to the slabs.  % thus not exhibiting the resonant phenomena http://photonics.inescporto.pt/links/fct2013-1/metap14.pdf
...
However,  Lord Rayleigh's studies on resonances in metallic gratings dates back to 1907 \cite{rayleigh1907dynamical}, when he focused on explaining the \textit{Wood's anomaly} discovered few years earlier to cause a sharp drop of grating reflectance caused by surface plasmons. % todo with the main conclusion that.. 
...
The transmitted power can be orders of magnitude higher than predicted by Bethe's law of inverse fourth power of the hole dimensions. The  %todo re-invented?
...
%Under a correct choice of parameters, the re-radiated wave has an opposite sign to the incoming one. In 2003, the 
...
\begin{figure}[t] \caption{Current-driven homogenization results for \textbf{(a)} an infinite array of metallic slabs divided by slits of $d_x = 20$ $\mu$m and with  \textbf{(b)} $\rho_c = 8$.. Both simulations share the metallic slab thickness $d_z = 20$ $\mu$m and transverse unit cell size $a_x  = a_x = 100$ $\mu$m. } \label{fg_cdh_yslit} \centering %{{{
	\vspace{.1\textwidth}
	\begin{overpic}[width=.48\textwidth]{img-cdh/cdh_emcSRRcap06.pdf}  
	\put(1,96) {\textbf{(a)}} 
	\put(18,100){\includegraphics[width=.1\textwidth]{img/drawing_emcSRRpad.pdf}}
...
\end{overpic}\\
  ...
  \vspace{20mm}} \label{fg_fnquadrup}
  \end{minipage}  
\end{figure} 
%}}}
