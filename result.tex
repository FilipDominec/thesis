...
\begin{figure}[t] \caption{Amplitude of reflectance, transmittance and retrieved effective index of refraction for the dielectric slab of 10\% fill fraction and varied permittivity $\epsrl \in \{4,9,16\}$} \label{fg_Slab_fillfraction015_epsilon_comparison} \centering 
\begin{tabular}{r}
\includegraphics[width=0.85\textwidth]{img-meep/Slab_fillfraction015_epsilon_comparison_r.pdf}\vspace{-10.5mm}\\
\includegraphics[width=0.85\textwidth]{img-meep/Slab_fillfraction015_epsilon_comparison_t.pdf}\vspace{-10.5mm}\\
\includegraphics[width=0.85\textwidth]{img-meep/Slab_fillfraction015_epsilon_comparison_nr.pdf}\vspace{-10.5mm}\\
\includegraphics[width=0.85\textwidth]{img-meep/Slab_fillfraction015_epsilon_comparison_ni.pdf}\vspace{-5mm}\\
\end{tabular}
\end{figure}
