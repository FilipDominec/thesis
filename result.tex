...
The notch becomes narrower, but does not appreciably reduce its depth. Always some frequency can be found where nearly 100 \% of the energy is transmitted through the structure, even when the slits are extremely narrow.

This phenomenon known as \textit{extraordinary transmission} is mediated by surface plasmons propagating along the front and rear surfaces of the metallic sheet. The notch in reflectance is always observed at the exact frequency that stipulates that the plasmon wavelength is equal to the unit cell size $a_x$.
