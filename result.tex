...
% left-handed at 450 GHz (First in THz band)
...
% Impedance matching by elliptic holes
% benzocyclobutene BCB permittivity constant: 2.6, loss tangent 0.005 to 0.01 at 1 THz.
% "zero transmission = antiresonance state"??
% 250x180um elliptic holes in thin gold films, 30-44 um spacing only
...
\add{
	Perforated plates: J. Rayleigh, “On the dynamical theory of gratings,” Proc. R. Soc. London A 79 , 399-416 (1907) 
	... artificial dielectric theerof \cite[p. 58]{brown1953artificial} % http://photonics.inescporto.pt/links/fct2013-1/metap14.pdf
	... The resonance in the metallic mesh has been known for half a century \cite{vogel1964transmission}
	... has been used as a filter \cite{ulrich1967effective,ulrich1967far}
...
Although fishnets appear to have nothing in common with the negative-index structures presented above, their interaction with electromagnetic wave in fact bears a close resemblance, at least to some degree of approximation. The conventional explanation of the negative refractive index of fishnets is based on a combination of negative effective permittivity and permeability. The former should results from the inductive effect of the metallic connections, acting similar to the wires oriented along the $x-$axis. 
