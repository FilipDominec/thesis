...
%\usepackage[top=3cm, bottom=3cm, inner=2.cm, outer=3.0cm, twoside]{geometry}  % two-sided print
\usepackage[top=3cm, bottom=3cm, inner=2.2cm, outer=3.4cm, twoside]{geometry}  % two-sided print with larger margins
