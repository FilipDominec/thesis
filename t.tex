...
\usepackage{graphicx,amsmath,amssymb,rotating,booktabs,color,enumitem, tikz, csquotes, placeins, pdflscape}
...
\begin{document}
 ...
 %
 %\chapter{Theory} 
 %{\hfill \textit{``There is nothing more practical than a good theory.''} --- probably K. Lewin}
 %\input{theory.tex}
 %
 %\chapter{Numerical methods} 
 %{\hfill \textit{``Computers are useless. They can only give you answers.''} --- P. Picasso (1968)}
 %\input{numeric.tex}
%
